...
const int fan Pin = D5;      // set digital pin D5 as fan pin (use active fan)
const int HVPin = D8;      // set digital pin D8 as HV pin (use high frequency transformer)
const int wifi HVPin = D0;  // set digital pin D0 as indication, the circuit on if NodeMCU connected to WiFi as STA mode
